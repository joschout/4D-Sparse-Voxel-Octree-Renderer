...
BasicGridRenderer::BasicGridRenderer(void)
{
}

void BasicGridRenderer::Render(const RenderContext& rc, const Grid const* grid, unsigned char* texture_array) const {
